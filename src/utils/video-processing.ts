import { defaultHLSConfig, defaultVideoConfig, useVideoConfigStore } from "@/store/video-config";
...
export const generateHLSPlaylist = ( segments: string[], duration: number  ): string => {
